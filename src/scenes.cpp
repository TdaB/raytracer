...
Scene scene1() {
    ...
    return Scene(width, height, spheres, lights, bounces);
}
...
Scene scene2() {
    ...
    vector<Sphere> spheres = {
        ...
        Sphere(Point(0, 100, 1600), 1000, Color(1, 1, 1), .01, .4, .1, 0, 40, 0),
		Sphere(Point(200, 200, 350), 80, Color(1, 0, 1), .01, .5, .5, .9, 50, 0)
    };
